...
class PlayerAnalyzer:
    ...
    def __init__(
        ...
        # Escala (será calculada o asignada)
    ...
    def calculate_distance(
        ...
        if not self.pixels_per_meter:
            raise ValueError("Escala píxeles-metros no calibrada. Usa set_scale_from_detections().")
        ...
        # Convierte a metros
        total_distance_m = total_distance_pixels / self.pixels_per_meter
        ...
        if distances:
            ...
            total_distance_m = sum(valid_distances) / self.pixels_per_meter
    ...
    def calculate_velocity(
        ...
        """
        if not self.pixels_per_meter:
            raise ValueError("Escala píxeles-metros no calibrada.")
    ...
    def calculate_intensity(
        ...
        # Distancia HSRS (High Speed Running/Sprinting > 6 m/s)
    ...
    def calculate_heatmap(
        ...
        for track in player_tracks:
            ...
            pos_x_m = center[0] / self.pixels_per_meter
            pos_y_m = center[1] / self.pixels_per_meter
